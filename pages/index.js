...
export default function Home() {
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 80001) {
      window.alert("Mumbai network has to be selected");
    }
      ...
      <nav id="header" className="w-full z-30 top-0 text-white py-1 lg:py-6">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-2 lg:py-6">
          <div className="pl-4 flex items-center">
            <a
              className="text-white no-underline hover:no-underline font-bold text-2xl lg:text-4xl text-black"
              href="#"
            >
              <svg
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 sm:w-1/2 p-6">
              <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">
                Draw Images and Create Metadata
              </h3>
              <p className="text-gray-600 mb-8">
                All complate by drawing on IPad 6 and Apple Pen, PFP layers
                combined.
                <br />
                <br />
                Generator:
                <a
                  ...
                  href="https://github.com/hashlisps"
                >
                  Hashlips
                </a>
              </p>
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              <div className="align-middle">
                <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">
                  Smart contract and Network Deploy
                </h3>
                <p className="text-gray-600 mb-8">
                  VSCode Solidiy smart contract created with Hardhat and
                  deployed to Mumbai (Polygon Testnet) Network
                  <br />
                  <br />
                  Polygon Mumbai Conract:
                  <a
                    className="text-orange-500 underline"
                    href="https://mumbai.polygonscan.com/address/0x6AB3fBF02765390966e1CbB35cfD5f787E004eFB#code"
                  >
                    My NFT contract
                  </a>
                </p>
            ...
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-600 text-base px-6 mb-5">
                  Unique 10 layers with 10~ different part ready to check. Let
                  me know for further info.
                </p>
              </a>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className="text-gray-600 text-base px-6 mb-5">
                  There too many networks and too many languages to learn. I
                  could start with one of them.
                </p>
              </a>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              ...
              >
                ...
                <p className=" text-gray-600 text-base px-6 mb-5">
                  Feel free to follow me on any social media. Also suppor me by
                  buying one of my nfts.
                </p>
              </a>
            </div>
          </div>
            ...
            <div className="flex-1">
              ...
              <ul className="list-reset mb-6">
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a
                    href="https://www.facebook.com/profile.php?id=100077667400674"
                ...
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a
                    href="https://www.instagram.com/0xgreatart/"
                    className="font-light no-underline hover:underline text-gray-800 hover:text-orange-500"
                  >
                    Instagram
                  </a>
                ...
                <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                  <a
                    href="https://www.twitter.com/0xgreatart/"
                    className="font-light no-underline hover:underline text-gray-800 hover:text-orange-500"
                  >
                    Twitter
                  </a>
